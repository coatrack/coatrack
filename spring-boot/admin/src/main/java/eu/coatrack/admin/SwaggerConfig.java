...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                ...
                .paths(PathSelectors.ant("/public-api/**")).build().apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
        return new ApiInfo("CoatRack Public API",
                ...
                null, null, null, "Apache License, Version 2.0", "https://www.apache.org/licenses/LICENSE-2.0");
    }
}
