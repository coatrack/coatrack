...
import eu.coatrack.admin.model.repository.InternalProxyRepository;
...
public class GatewayAuthProvider implements AuthenticationProvider {
    ...
    @Autowired
    private InternalProxyRepository internalProxyRepository;
    ...
    private boolean isAuthTokenValid(GatewayAuthToken authToken) throws AuthenticationException {
        ...
        try {
            ...
            Proxy proxy = internalProxyRepository.findById(gatewayUUID).orElse(null);
