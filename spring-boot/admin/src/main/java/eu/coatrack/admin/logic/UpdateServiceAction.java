 ...
 */
@Component
public class UpdateServiceAction extends AbstractServiceAction implements Action {

    private static final Logger log = LoggerFactory.getLogger(UpdateServiceAction.class);
