...
public class ServiceApi implements ServiceApiInterface {
    ...
    /**
     *
     * @return the URL in the local area network of the service API provider where the service can be reached via the
     *         service gateway
     */
    ...
    public String toString() {
        return "ServiceApi{" + "id=" + id + ", name='" + name + '\'' + ", uriIdentifier='" + uriIdentifier + '\''
                + ", localUrl='" + localUrl + '\'' + ", user=" + owner + '}';
    }
}
